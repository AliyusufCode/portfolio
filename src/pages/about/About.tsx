...
const About = () => {
  return (
    <div className={styles.container}>
      ...
      <p>
        <span style={{ marginLeft: 30 }}>Заинтересовался</span> web-разработкой
        более года назад. До этого занимался разработкой телеграм ботов на
        Python. Для достижения своей цели прикладывал много усилий - обучался на
        бесплалатных курсах, занимаюсь самообразованием, практикую написание
        кода, решаю задачи по программированию. Умею верстать адаптивные сайты,
        создавать динамичекие веб-приложения (клиент/сервер). Стремлюсь
        совершенствовать навыки учитывая новые тенденции в отрасли.
      </p>
