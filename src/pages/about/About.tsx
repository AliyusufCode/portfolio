...
const About = () => {
  return (
    <div className={styles.container}>
      ...
      <p>
        <p style={{ marginLeft: 30 }}>Заинтересовался</p> web-разработкой более
        года назад. До этого занимался разработкой телеграм ботов на Python. Для
        достижения своей цели прикладывал много усилий - обучался на
